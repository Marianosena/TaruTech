...
const nuevoAtrivutoEd = document.getElementById('nuevoAtributo')
...
document.getElementById("botonEditar").addEventListener("click", function (event) {
    ...
    let nuevoAtributo = nuevoAtrivutoEd.value
    let van = false
    ...
    if (productoEditar == '' || atributoEditar == '' || nuevoAtributo == '') {
        ...
        if (van == true) {
            ...
            setTimeout(() => {
                mensaje.classList.remove('noExtisteError')
            }, 2500);
        }
