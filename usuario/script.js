...
function finalizarCompra() {
    if (lista.length > 0) {
       swal.fire({
        ...
        // Reinicia todas las variables y almacenamiento 
        lista = [];
        valortotal = 0;
        guardarAlmacenamientoLocal("productos", productos);
        numero.innerHTML = "0";
        ...
        swal.fire({
            title:"El carrito está vacío. ¡Agrega productos antes de finalizar la compra!"
           }) 
...
const botonFinalizarCompra = document.querySelector("#contenedorCompra button");
